...
{
    /**
     * Tablas de permisos Spatie por tenant.
     * Modificada para usar UUID en model_morph_key (compatible con User UUID).
     */
    public function up(): void
    {
        ...
        // Permisos individuales (ej: "invoices.create", "products.delete")
        ...
        // Roles (ej: "admin", "contador", "vendedor")
        ...
        // Pivot: modelo → permiso (model_id es UUID porque User usa UUID)
        Schema::create($tableNames['model_has_permissions'], function (Blueprint $table) use ($tableNames, $columnNames, $pivotPermission, $teams) {
            $table->unsignedBigInteger($pivotPermission);
            $table->string('model_type');
            $table->uuid($columnNames['model_morph_key']);        // UUID en lugar de unsignedBigInteger
