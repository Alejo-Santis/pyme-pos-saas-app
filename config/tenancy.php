...
return [
    'tenant_model' => \App\Modules\Tenant\Models\Tenant::class,
    ...
    'database' => [
        ...
        /**
         * Schema-based tenancy: cada tenant tiene su propio schema PostgreSQL.
         * Manager personalizado que envuelve el nombre en comillas dobles para
         * soportar UUIDs (con dashes) como nombres de schema válidos en PostgreSQL.
         */
            'pgsql' => \App\Modules\Tenant\PostgreSQLSchemaManager::class,
        ],
    ],
